...
//game1.Leopard is a subclass of game1.Animal
public class Leopard extends Animal {
    ...
    /*-----Methods-----*/
    // game1.Leopard is a contructor which accepts 2 parameters, player and game1.Position
    public Leopard(int player, Position p) {
        super(player, p, "4 = Leopard",500);
        this.player = player;
        this.p = p;
        lastKilledEnemy = -1;
    }
            ...
            if (enemy != null) {
                ...
                if(c instanceof Trap){
                    ...
                    if(enemy.getPlayer() != c.getPlayer()){
                        ...
                        board.boardMoves.push(new int[]{this.player,4, this.getPosition().getX(), this.getPosition().getY(),lastKilledEnemy});
    ...
    public String toString() {
        return player==1? "\u001B[31mJ\u001B[0m":"\u001B[32mJ\u001B[0m";
    }
