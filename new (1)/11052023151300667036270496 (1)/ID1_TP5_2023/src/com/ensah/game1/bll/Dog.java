...
//game1.Dog is a subclass of game1.Animal
public class Dog extends Animal {
    ...
    /*-----Methods-----*/
    // game1.Dog is a contructor which accepts 2 parameters, player and game1.Position
    public Dog(int player, Position p) {
        super(player, p, "3 = Dog",400);
        this.player = player;
        this.p = p;
        lastKilledEnemy = -1;
    }
            ...
            if (enemy != null) {
                ...
                if(c instanceof Trap){
                    ...
                    if(enemy.getPlayer() != c.getPlayer()){
                        ...
                        board.boardMoves.push(new int[]{this.player,3, this.getPosition().getX(), this.getPosition().getY(),lastKilledEnemy});
    ...
    public String toString() {
        return player==1? "\u001B[31mD\u001B[0m":"\u001B[32mD\u001B[0m";
    }
