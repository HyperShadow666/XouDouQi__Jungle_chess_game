...
public class Cat extends Animal {
            ...
            if (enemy != null) {
                ...
                if(c instanceof Trap){
                    ...
                    if(enemy.getPlayer() != c.getPlayer()){
                        ...
                        board.boardMoves.push(new int[]{this.player,1, this.getPosition().getX(), this.getPosition().getY(),lastKilledEnemy});
    ...
    public String toString() {
        return player==1? "\u001B[31mC\u001B[0m":"\u001B[32mC\u001B[0m";
    }
