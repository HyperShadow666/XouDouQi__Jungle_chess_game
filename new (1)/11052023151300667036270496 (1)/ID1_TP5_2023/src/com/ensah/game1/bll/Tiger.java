...
//game1.Tiger is a subclass of game1.Animal
public class Tiger extends Animal {
    ...
    /*-----Methods-----*/
    // game1.Tiger is a contructor which accepts 2 parameters, player and game1.Position
    public Tiger(int player, Position p) {
        super(player, p, "5 = Tiger",700);
        this.player = player;
        this.p = p;
        lastKilledEnemy = -1;
    }
            ...
            if (enemy != null) {
                ...
                if(c instanceof Trap){
                    ...
                    if(enemy.getPlayer() != c.getPlayer()){
                        ...
                        board.boardMoves.push(new int[]{this.player,5, this.getPosition().getX(), this.getPosition().getY(),lastKilledEnemy});
                        enemy.setDead(true);
                        getPosition().setX(x);
                        getPosition().setY(y);
    ...
    public String toString() {
        return player==1? "\u001B[31mT\u001B[0m":"\u001B[32mT\u001B[0m";
    }
