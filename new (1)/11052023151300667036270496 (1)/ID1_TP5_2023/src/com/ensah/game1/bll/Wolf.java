...
//game1.Wolf is a subclass of game1.Animal
public class Wolf extends Animal {
    ...
    /*-----Methods-----*/
    // game1.Wolf is a contructor which accepts 2 parameters, player and game1.Position
    public Wolf(int player, Position p) {
        super(player, p, "2 = Wolf",300);
        this.player = player;
        this.p = p;
        lastKilledEnemy = -1;
    }
            ...
            if (enemy != null) {
                ...
                if(c instanceof Trap){
                    ...
                    if(enemy.getPlayer() != c.getPlayer()){
                        ...
                        board.boardMoves.push(new int[]{this.player,2, this.getPosition().getX(), this.getPosition().getY(),lastKilledEnemy});
    ...
    public String toString() {
        return player==1? "\u001B[31mW\u001B[0m":"\u001B[32mW\u001B[0m";
    }

    @Override
    public void addLegalMove( Animal[] a1, Animal[] a2, Cell[][] cell, ChessBoard board) {
